...
export const migrations = [
  ...
  },
  {
    ...
    statements: [
      ...
      `CREATE INDEX IF NOT EXISTS idx_action_runs_project_updated ON action_runs (project_id, updated_at DESC);`,
      `CREATE UNIQUE INDEX IF NOT EXISTS idx_action_runs_active_fingerprint
        ON action_runs (project_id, action_id, input_fingerprint)
