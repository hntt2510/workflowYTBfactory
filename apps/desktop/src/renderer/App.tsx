      ...
      <SectionCard title="9Router">
        <div className="form-grid">
          ...
          <div className="capability-card">
            ...
            <StatusBadge tone={modelListTone(modelListStatus)}>{creatorStatusLabel(modelListStatus)}</StatusBadge>
