...
function webFallback(): LongShortFactoryApi {
  ...
  return {
    ...
    async listActiveActionRuns() { return []; },
    ...
    async runStoryArchitecture(): Promise<FactoryProject> { throw new Error("Electron main process unavailable."); },
    async listStoryArchitectureArtifacts() { return []; },
    async approveStoryArchitecture(): Promise<FactoryProject> { throw new Error("Electron main process unavailable."); },
    async rejectStoryArchitecture(): Promise<FactoryProject> { throw new Error("Electron main process unavailable."); },
    ...
    async runScriptReview(): Promise<FactoryProject> { throw new Error("Electron main process unavailable."); },
    async listScriptReviewArtifacts() { return []; },
    async reviseScript(): Promise<FactoryProject> { throw new Error("Electron main process unavailable."); },
